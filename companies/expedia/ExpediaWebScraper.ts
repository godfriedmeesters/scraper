...
export class ExpediaWebScraper extends WebScraper implements IScraper {
    ...
    async scrapeUntilSearch(inputData: any) {
        ...
        //optional customer satisfaction form
        await this.clickOptionalElementByXpath(`//button[contains(text(), '${this.translator.translate("nein")}')]`);
    ...
    async scrapeFromSearch(inputData) {
        ...
        await this.clickElementByXpath("//label[@for='stops-0']");
